# NOTE: This is only here because my media-sound/vgmstream-cli requires dev-dotnet/gtk-sharp which requires dev-build/automake:1.16
# And as of June 2025, gentoo REMOVED 1.16 from portage tree. Maybe this can be removed if I either update vgmstream-cli/gtk-sharp or remove
# gtk-sharp as a dependency
